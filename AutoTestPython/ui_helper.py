...
class OperationsHelper(BasePage):
    ...
    def enter_login(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_LOGIN_FIELD"], word,
                                    description=f"Send {word} to element LOGIN_FIELD")

    def enter_pass(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_PASS_FIELD"], word,
                                    description=f"Send {word} to element PASS_FIELD")

    def input_title_post(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_POST_TITLE_FIELD"], word,
                                    description=f"Send {word} to element POST_TITLE_FIELD")

    def input_description_post(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_POST_DESCRIPTION_FIELD"], word,
                                    description=f"Send {word} to element POST_DESCRIPTION_FIELD")

    def input_content_post(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_POST_CONTENT_FIELD"], word,
                                    description=f"Send {word} to element POST_CONTENT_FIELD")

    def enter_your_name(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_YOUR_NAME_CONTACT"], word,
                                    description=f"Send {word} to element NAME_CONTACT")

    def enter_your_email(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_YOUR_EMAIL_CONTACT"], word,
                                    description=f"Send {word} to element EMAIL_CONTACT")

    def enter_your_content(self, word):
        self.enter_text_intro_field(TestSearchLocators.ids["LOCATOR_CONTENT_CONTACT"], word,
